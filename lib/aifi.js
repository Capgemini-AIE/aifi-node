...
const DEFAULT_HOST = 'oasis-api.public-sandbox.client.aifi.io';
...
/**
 * Creates an HTTP client for issuing Aifi API requests which uses the Web
 * Fetch API.
 *
 * A fetch function can optionally be passed in as a parameter. If none is
 * passed, will default to the default `fetch` function in the global scope.
 */
Aifi.createFetchHttpClient = (fetchFn) => {
